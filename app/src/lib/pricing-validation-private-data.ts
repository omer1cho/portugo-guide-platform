...
const OBIDOS_PRIVATE: PrivateTour = {
  ...
  priceInfoExtra: 'רכב יקר יותר מסינטרה (449-581€ במקום 326-483€) — לכן מחיר/אדם גבוה יותר בכל קטגוריה. כניסות פר-אדם: 15€ אתרים + 3€ תצפית גלישה = 18€.',
  maxParticipants: 50,
  regularPrice: {
    label: 'מחיר רגיל',
  ...
  children: {
    ...
    note: 'בפרטי הרכב כבר משולם ע"י הקבוצה — אז ילדים עד 6 חינם לגמרי. ילד 7-12 משלם חצי מהמחיר/אדם. כניסות (מנזר 15€ + תצפית גלישה 3€) — בינתיים מחיר מבוגר מלא עד שנברר עם הספקים.',
  },
};
