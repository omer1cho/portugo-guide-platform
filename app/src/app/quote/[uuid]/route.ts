...
(function(){
  ...
  //      "להוסיף עוד סיור" משקפים רק את הסיורים שכן נכנסו להצעה (כולל אפשרויות
  //      בוקר/צהריים של אותו סיור), ולעולם לא סיורים שמחוץ להצעה. גם בהצעת סיור
  //      בודד הסקציה נשארת, כדי שהלקוח תמיד יוכל להוסיף מלמטה את מה שבהצעה.
