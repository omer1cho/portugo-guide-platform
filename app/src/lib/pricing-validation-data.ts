...
const OBIDOS_REG_ROWS: ScenarioRow[] = [
  { size: 2, income: 210, guideSalary: 75, attractionCost: 36, daily: 15, carText: '383 / 449', profitA: loss(-299), profitB: loss(-365) },
  { size: 4, income: 420, guideSalary: 75, attractionCost: 72, daily: 15, carText: '383 / 449', profitA: loss(-125), profitB: loss(-191) },
  { size: 5, income: 525, guideSalary: 75, attractionCost: 90, daily: 15, carText: '383 / 449', profitA: loss(-38), profitB: loss(-104) },
  { size: 6, income: 630, guideSalary: 75, attractionCost: 108, daily: 15, carText: '383 / 449', profitA: profit(49), profitB: loss(-17) },
  { size: 7, income: 735, guideSalary: 75, attractionCost: 126, daily: 15, carText: '383 / 449', profitA: profit(136), profitB: profit(70) },
  { size: 8, income: 840, guideSalary: 83, attractionCost: 144, daily: 15, carText: '401 / 449', profitA: profit(197), profitB: profit(149) },
  { size: 10, income: 1050, guideSalary: 85, attractionCost: 180, daily: 15, carText: '441 / 512', profitA: profit(329), profitB: profit(258) },
  { size: 12, income: 1260, guideSalary: 87, attractionCost: 216, daily: 15, carText: '441 / 512', profitA: profit(501), profitB: profit(430) },
  { size: 15, income: 1575, guideSalary: 90, attractionCost: 270, daily: 15, carText: '441 / 537', profitA: profit(759), profitB: profit(663) },
  { size: 16, income: 1680, guideSalary: 91, attractionCost: 288, daily: 15, carText: '462 / 581', profitA: profit(824), profitB: profit(705) },
  { size: 20, income: 2100, guideSalary: 95, attractionCost: 360, daily: 15, carText: '462 / 581', profitA: profit(1168), profitB: profit(1049) },
  { size: 25, income: 2625, guideSalary: 100, attractionCost: 450, daily: 15, carText: '462 / 581', profitA: profit(1598), profitB: profit(1479) },
  { size: 30, income: 3150, guideSalary: 105, attractionCost: 540, daily: 15, carText: '504 / —', profitA: profit(1986), profitB: na('פרדאוטו בלעדי') },
  { size: 34, income: 3570, guideSalary: 109, attractionCost: 612, daily: 15, carText: '504 / —', profitA: profit(2330), profitB: na('פרדאוטו בלעדי') },
];

const OBIDOS_PKG_ROWS: ScenarioRow[] = [
  { size: 2, income: 200, guideSalary: 75, attractionCost: 36, daily: 15, carText: '383 / 449', profitA: loss(-309), profitB: loss(-375) },
  { size: 4, income: 400, guideSalary: 75, attractionCost: 72, daily: 15, carText: '383 / 449', profitA: loss(-145), profitB: loss(-211) },
  { size: 5, income: 500, guideSalary: 75, attractionCost: 90, daily: 15, carText: '383 / 449', profitA: loss(-63), profitB: loss(-129) },
  { size: 6, income: 600, guideSalary: 75, attractionCost: 108, daily: 15, carText: '383 / 449', profitA: marginal(19), profitB: loss(-47) },
  { size: 7, income: 700, guideSalary: 75, attractionCost: 126, daily: 15, carText: '383 / 449', profitA: profit(101), profitB: marginal(35) },
  { size: 8, income: 800, guideSalary: 83, attractionCost: 144, daily: 15, carText: '401 / 449', profitA: profit(157), profitB: profit(109) },
  { size: 10, income: 1000, guideSalary: 85, attractionCost: 180, daily: 15, carText: '441 / 512', profitA: profit(279), profitB: profit(208) },
  { size: 12, income: 1200, guideSalary: 87, attractionCost: 216, daily: 15, carText: '441 / 512', profitA: profit(441), profitB: profit(370) },
  { size: 15, income: 1500, guideSalary: 90, attractionCost: 270, daily: 15, carText: '441 / 537', profitA: profit(684), profitB: profit(588) },
  { size: 16, income: 1600, guideSalary: 91, attractionCost: 288, daily: 15, carText: '462 / 581', profitA: profit(744), profitB: profit(625) },
  { size: 20, income: 2000, guideSalary: 95, attractionCost: 360, daily: 15, carText: '462 / 581', profitA: profit(1068), profitB: profit(949) },
  { size: 25, income: 2500, guideSalary: 100, attractionCost: 450, daily: 15, carText: '462 / 581', profitA: profit(1473), profitB: profit(1354) },
  { size: 30, income: 3000, guideSalary: 105, attractionCost: 540, daily: 15, carText: '504 / —', profitA: profit(1836), profitB: na('פרדאוטו בלעדי') },
  { size: 34, income: 3400, guideSalary: 109, attractionCost: 612, daily: 15, carText: '504 / —', profitA: profit(2160), profitB: na('פרדאוטו בלעדי') },
];
...
export const TOURS: Tour[] = [
  ...
  },
  {
    slug: 'obidos',
    name: 'אובידוש',
    priceInfo: 'מחיר ללקוח: 105€ · 100€ בחבילה · אין שינוי עונתי · כולל: שכר מדריך + אשל 15€ + מנזר 15€ + תצפית גלישה 3€ + רכב',
    ...
    miniTable: {
      ...
      rows: [
        ...
        { size: 3, values: ['180€', '200€'] },
        { size: 4, values: ['140€', '155€'] },
        { size: 5, values: ['115€', '130€'] },
      ],
    },
    scenarios: [
...
const CULINARY_MORNING_REG_ROWS: TastingScenarioRow[] = [
  ...
  { size: 8, income: 520, guideSalary: 48, perPersonFood: 149, sharedCosts: [6], totalCost: 203, profit: profit(317) },
  { size: 10, income: 650, guideSalary: 50, perPersonFood: 186, sharedCosts: [6], totalCost: 242, profit: profit(408) },
  { size: 12, income: 780, guideSalary: 52, perPersonFood: 224, sharedCosts: [6], totalCost: 282, profit: profit(498) },
  { size: 15, income: 975, guideSalary: 55, perPersonFood: 280, sharedCosts: [9], totalCost: 343, profit: profit(632) },
  { size: 20, income: 1300, guideSalary: 60, perPersonFood: 373, sharedCosts: [9], totalCost: 441, profit: profit(859) },
];
...
const CULINARY_MORNING_PKG_ROWS: TastingScenarioRow[] = [
  ...
  { size: 8, income: 480, guideSalary: 48, perPersonFood: 149, sharedCosts: [6], totalCost: 203, profit: profit(277) },
  { size: 10, income: 600, guideSalary: 50, perPersonFood: 186, sharedCosts: [6], totalCost: 242, profit: profit(358) },
  { size: 12, income: 720, guideSalary: 52, perPersonFood: 224, sharedCosts: [6], totalCost: 282, profit: profit(438) },
  { size: 15, income: 900, guideSalary: 55, perPersonFood: 280, sharedCosts: [9], totalCost: 343, profit: profit(557) },
  { size: 20, income: 1200, guideSalary: 60, perPersonFood: 373, sharedCosts: [9], totalCost: 441, profit: profit(759) },
];
...
const CULINARY_LUNCH_REG_ROWS: TastingScenarioRow[] = [
  ...
  { size: 8, income: 520, guideSalary: 48, perPersonFood: 159, sharedCosts: [6], totalCost: 213, profit: profit(307) },
  { size: 10, income: 650, guideSalary: 50, perPersonFood: 199, sharedCosts: [6], totalCost: 255, profit: profit(395) },
  { size: 12, income: 780, guideSalary: 52, perPersonFood: 238, sharedCosts: [6], totalCost: 296, profit: profit(484) },
  { size: 15, income: 975, guideSalary: 55, perPersonFood: 298, sharedCosts: [9], totalCost: 361, profit: profit(614) },
  { size: 20, income: 1300, guideSalary: 60, perPersonFood: 397, sharedCosts: [9], totalCost: 466, profit: profit(834) },
];
...
const CULINARY_LUNCH_PKG_ROWS: TastingScenarioRow[] = [
  ...
  { size: 8, income: 480, guideSalary: 48, perPersonFood: 159, sharedCosts: [6], totalCost: 213, profit: profit(267) },
  { size: 10, income: 600, guideSalary: 50, perPersonFood: 199, sharedCosts: [6], totalCost: 255, profit: profit(345) },
  { size: 12, income: 720, guideSalary: 52, perPersonFood: 238, sharedCosts: [6], totalCost: 296, profit: profit(424) },
  { size: 15, income: 900, guideSalary: 55, perPersonFood: 298, sharedCosts: [9], totalCost: 361, profit: profit(539) },
  { size: 20, income: 1200, guideSalary: 60, perPersonFood: 397, sharedCosts: [9], totalCost: 466, profit: profit(734) },
];
...
export const TASTING_TOURS: TastingTour[] = [
  ...
  },
  {
    ...
    priceInfoExtra: 'לאדם: קפה ומאפה ~2.5€, פשטל 2€, מרק 1.92€, ויטור ~2.15€, סרדינים 8.5€/10€, ז\'ינז\'יניה 1.5€, כוס · משותף: גווארנה 3€/בקבוק לכל 7',
  ...
  },
  {
    ...
    name: 'קולינרי צהריים',
    priceInfo: 'מחיר ללקוח: 65€ רגיל · 60€ חבילה · כולל: שכר מדריך + מוצרים לאדם + גווארנה משותפת',
    priceInfoExtra: 'לאדם: בקלאו 4€, ויטור ~2.15€, סרדינים 8.5€/10€, ז\'ינז\'יניה 1.5€, אמפדה 1.7€, קרוקט 1.95€, כוס · משותף: גווארנה 3€/בקבוק לכל 7',
    perPersonLabel: 'מוצרים לאדם',
    sharedCostLabels: ['גווארנה'],
    scenarios: [
  ...
  },
  {
    ...
    priceInfoExtra: 'לאדם: לביבה 3€, יקב 10€, יין אדום 3.5€, בריגדיירו 2.12€, בירה 1€, כוס · משותף: מגש גבינות 12.19€ לכל 3 · פאו דה קז\'ו ~7.75€ לכל 4 · יין ירוק ~3.5€ לכל 6',
    perPersonLabel: 'מוצרים לאדם',
    ...
    childrenPrices: {
      rows: [
        { ageLabel: 'עד 2', regular: 'חינם', pkg: 'חינם' },
        { ageLabel: '3-6', regular: '15€', pkg: '10€' },
        { ageLabel: '7-12', regular: '35€', pkg: '30€' },
        { ageLabel: '13+', regular: '65€', pkg: '60€' },
      ],
      note: 'עד 2: חינם · 3-6: טעימות חלקיות · 7-12: כ-60% מנה · 13+: מחיר מבוגר מלא. מחירי הילדים בטעימות נמוכים ב-5€ מקולינרי (הנחיית עומר 19.7.26). הסיור כולל אלכוהול — מתאים בעיקר ל-13+.',
    },
  },
];
