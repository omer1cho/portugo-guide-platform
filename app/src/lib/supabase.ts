...
export type Guide = {
  ...
  is_admin: boolean;
  /** האם המשתמש הזה הוא מדריך פעיל שמשבצים אותו על סיורים?
   *  ברירת מחדל true (כל המדריכים הקיימים).
   *  אדמינים שאינם מדריכים (עומר, פורטוגו) — false.
   *  אדמינים שגם מדריכים (רונה) — true. */
  is_guide?: boolean;
