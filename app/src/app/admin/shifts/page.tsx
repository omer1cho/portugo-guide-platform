...
// Palette צבעים נעימה למדריכים — 14 צבעים עם ניגודיות טקסט גבוהה.
...
const GUIDE_PALETTE: Array<{ bg: string; fg: string; border: string }> = [
  ...
  { bg: '#d8c3ab', fg: '#5c3a1e', border: '#b08d63' }, // חום (brown)
];
...
const GUIDE_COLOR_BY_NAME: Record<string, number> = {
  ...
  'נופר': 13,     // חום (נפרד מהוורוד של אביב והסגול של מאיה בליסבון)
};
