...
<div dir="rtl" style="font-family:'Segoe UI',Arial,sans-serif; background:#f3f4f6; padding:24px 12px; color:#1f2937;">
  ...
  <div style="max-width:640px; margin:0 auto; background:#ffffff; border-radius:14px; overflow:hidden; border:1px solid #e5e7eb;">
    ...
    <div style="padding:22px 28px; background:#f0fdf4; border-bottom:1px solid #f3f4f6; text-align:right;">
      ...
      <div style="font-size:14.5px; line-height:1.7; padding:5px 0;">🟩 <strong>יותר אנשים, פחות רווח:</strong> 307 משתתפים (עלייה של 26%) אבל הרווח הגולמי המוערך ירד ב-8% ל-4,931€. התמהיל קובע, לא הכמות.</div>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse:separate; border-spacing:5px;">
        <tr>
          <td width="25%" style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:10px; padding:12px 10px; text-align:right; vertical-align:top;">
            ...
            <div style="font-size:20px; font-weight:700; color:#111827;">4,931€</div>
            <div style="font-size:12px; font-weight:600; color:#b91c1c;">▼ 8% (היו 5,342€)</div>
          </td>
          <td width="25%" style="background:#f9fafb; border:1px solid #e5e7eb; border-radius:10px; padding:12px 10px; text-align:right; vertical-align:top;">
    ...
    <div style="padding:22px 28px; border-bottom:1px solid #f3f4f6; text-align:right;">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:13px; border-collapse:collapse;">
        ...
        <tr><td style="padding:7px 0; font-weight:600;">דורו</td><td style="text-align:center;">2</td><td style="text-align:center;">24</td><td style="text-align:center;">2,464€</td><td style="text-align:center; color:#9ca3af;">1,418€</td><td style="text-align:center; font-weight:700;">1,046€</td><td style="text-align:center; color:#15803d; font-weight:700;">44€</td></tr>
    ...
    <div style="padding:22px 28px; border-bottom:1px solid #f3f4f6; text-align:right;">
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:13px; width:100%;">
        ...
        <tr><td style="color:#4b5563; padding:3px 0;">חמישי</td><td><div style="height:13px; width:99%; max-width:306px; border-radius:4px; background:#16a34a;"></div></td><td style="color:#6b7280; font-size:12px; padding-right:8px; white-space:nowrap;">3,045€ · 20 סיורים</td></tr>
        <tr><td style="color:#4b5563; padding:3px 0;">שני</td><td><div style="height:13px; width:61%; max-width:188px; border-radius:4px; background:#4ade80;"></div></td><td style="color:#6b7280; font-size:12px; padding-right:8px; white-space:nowrap;">1,873€ · 11 סיורים</td></tr>
      ...
      <div style="margin-top:10px; font-size:13.5px; color:#111827; background:#f9fafb; border-radius:8px; padding:8px 12px; line-height:1.65;">
        <strong style="color:#166534;">מה זה אומר:</strong> חמישי ושישי מייצרים 55% מהרווח החודשי. שבת וראשון יחד: 733€ בלבד,
